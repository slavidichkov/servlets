...
public class SimpleStringCalculatorTest{
  ...
  public void happyPath() {
      ...
      assertThat("62.0",is(equalTo(expected)));
  }

  @Test
  public void evaluateWhitSumAndMultiplication() {
      String expected = stringCalculator.eval("3+2*2");
      assertThat("7.0",is(equalTo(expected)));
  }

  @Test
  public void evaluateWhitSumAndTwoMultiplication() {
    String expected = stringCalculator.eval("3+2*4*5");
    assertThat("43.0",is(equalTo(expected)));
  }
  ...
  public void evaluateMultiplication() {
      ...
      assertThat("25.0",is(equalTo(expected)));
  }
